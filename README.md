...
types, inline structures and unions, arrays and pointers of known
types. Fields of the following types are not supported: inline
strings, enums, function pointers, bitfields and arrays of
