...
TYPEDEF_ENUM (rl_message_id_t, ATTRIBUTES ( , "Messages enum. Message string saved in .comment field of meta info"),
	      ...
	      (RL_MESSAGE_TYPE_NOT_UNION, , "Type '%s' is not a union."),
	      ...
	      (RL_MESSAGE_XML_STRING_ENCODING_FAILED, , "XML2 encoding failed for string '%s'."),
...
TYPEDEF_ENUM (rl_ptrdes_flags_t, ATTRIBUTES (__attribute__ ((packed, aligned (sizeof (uint8_t)))) , "ponter descriptor flag bitmask values"),
	      (RL_PDF_NONE, = 0),
	      (RL_PDF_IS_NULL, = (1 << 0)),
