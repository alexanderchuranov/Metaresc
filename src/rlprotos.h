...
RL_TYPEDEF_ENUM () /* Messages enum. Message string saved in .comment field of meta info */
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_OUT_OF_MEMORY, , "Out of memory.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_UNEXPECTED_END, , "Unexpected end of file or end of string.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_UNEXPECTED_DATA, , "Unexpected data in stream.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_UNBALANCED_TAGS, , "Unbalanced tags.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_XDR_WRONG_ENCODING_MODE, , "XDR wrong encoding mode.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_XDR_SAVE_FAILED, , "XDR save to resizable array failed.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_XML_SAVE_FAILED, , "XML save failed.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_LOAD_STRUCT_FAILED, , "Structure load failed.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_LOAD_METHOD_MISSED, , "Load method missed.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_XDR_LOAD_FAILED, , "XDR load failed.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_NO_TYPE_DESCRIPTOR, , "Can't find type descriptor for '%s'.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_NOT_A_UNION, , "Type '%s' is not a union.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_NULL_POINTER, , "Can't save/load to/from NULL pointer.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_IDS_COLLISION, , "Two XML nodes have the same %s=%" SCNd32 ".")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_UNDEFINED_REF_IDX, , "Reference on a node with %s=%" SCNd32 " could not be found.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_UNKNOWN_ENUM, , "Unknown enum value '%s'.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_READ_INT, , "Can't read integer value from string `%s`.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_READ_ENUM, , "Can't read enum value from string `%s`.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_READ_BITMASK, , "Can't read bitmask from string `%s`.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_READ_FLOAT, , "Can't read float from string `%s`.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_READ_DOUBLE, , "Can't read double from string `%s`.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_READ_LONG_DOUBLE, , "Can't read long double from string `%s`.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_READ_CHAR, , "Can't read char from string `%s`.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_STRING_TRUNCATED, , "Char array range check: string truncated.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_UNKNOWN_SUBNODE, , "Struct type '%s': unknown subnode '%s'.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_SAVE_IDX_RANGE_CHECK, , "Save node index is out of range.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_NODE_NAME_MISSMATCH, , "Node name mismatch: expected '%s' got '%s'.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_NODE_TYPE_MISSMATCH, , "Node type mismatch: expected '%s' got '%s'.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_UNSUPPORTED_NODE_TYPE, , "Unsupported node type: rl_type_ext %" SCNd32 " rl_type %" SCNd32 ".")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_RANGE_CHECK, , "Range check error in array '%s'.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_READ_REF, , "Can't read '%s' ref index.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_TYPE_NOT_ENUM, , "Type '%s' is not a enum.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_SAVE_ENUM, , "Can't find enum name for value %" SCNd64 " type '%s'.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_SAVE_BITMASK, , "Can't decompose on bitmask %llu.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_DUPLICATED_ENUMS, , "Duplicated enum definition for `%s` in enum '%s'.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_DUPLICATED_FIELDS, , "Duplicated field definition for `%s` in type '%s'. Incorrect results are possible!")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_INT_OF_UNKNOWN_SIZE, , "Failed to stringify integer of unknown size: %" SCNd32 ".")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_PARSE_ERROR, , "Parser error: '%s'. Position: %" SCNd32 ":%" SCNd32 "-%" SCNd32 ":%" SCNd32 ".")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_ANON_UNION_TYPE_ERROR, , "Can't create type for anonymous union due to type name collision: '%s'.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_UNKNOWN_XML_ESC, , "Unknown XML escape sequence '%s'.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_WRONG_XML_ESC, , "Wrong XML escape sequence '%s'.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_TYPES_HASHES_MATCHED, , "For types '%s' and '%s' hashes matched. Last type is not available.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_RARRAY_LOAD_FAILED, , "Failed to find field .data in C-style data.")
  RL_COMMENTED_ENUM_DEF (RL_MESSAGE_LAST, , "Last message ID.")
...
RL_TYPEDEF_ENUM ()
  ...
  RL_ENUM_DEF (RL_TYPE_CHAR)
  RL_ENUM_DEF (RL_TYPE_CHAR_ARRAY)
  RL_ENUM_DEF (RL_TYPE_STRING)
  ...
  RL_COMMENTED_ENUM_DEF (RL_TYPE_LAST, , "keep it last")
...
RL_TYPEDEF_ENUM ()
  ...
  RL_COMMENTED_ENUM_DEF (RL_TYPE_EXT_LAST, , "keep it last")
RL_END_ENUM ("ResLib type extension enum")

/* rl_rarray_t defenition should be syncroonized with RL_MP_RARRAY macro */
#undef RL_TYPE_NAME
