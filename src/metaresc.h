...
#ifndef MR_PRINT_SERIALIZATION_METHOD
#define MR_PRINT_SERIALIZATION_METHOD CINIT
#endif /* MR_PRINT_SERIALIZATION_METHOD */

#define MR_PRINT_IN_PAREN(COUNT, FD, VALUE)		\
  MR_IF_ELSE (MR_PASTE2 (EQ_2_, COUNT))			\
       (MR_PRINT_IN_PAREN_ (COUNT, FD, VALUE))		\
       (MR_PRINT_STRUCT_ (FD, MR_REMOVE_PAREN_ VALUE, MR_PRINT_SERIALIZATION_METHOD))
