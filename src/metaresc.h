...
#define MR_POINTER_SIZE_SUFFIX _size
#define MR_POINTER_SIZE_SUFFIX_STR MR_STRINGIFY_READONLY (MR_POINTER_SIZE_SUFFIX)
#define MR_POINTER_SIZE_FIELD(FIELD) MR_PASTE2 (FIELD, MR_POINTER_SIZE_SUFFIX)
#define MR_POINTER_COUNT_SUFFIX _count
#define MR_POINTER_COUNT_SUFFIX_STR MR_STRINGIFY_READONLY (MR_POINTER_COUNT_SUFFIX)
#define MR_POINTER_COUNT_FIELD(FIELD) MR_PASTE2 (FIELD, MR_POINTER_COUNT_SUFFIX)
#define MR_UNION_DISCRIMINATOR_SUFFIX _discriminator
#define MR_UNION_DISCRIMINATOR_SUFFIX_STR MR_STRINGIFY_READONLY (MR_UNION_DISCRIMINATOR_SUFFIX)
#define MR_UNION_DISCRIMINATOR_FIELD(FIELD) MR_PASTE2 (FIELD, MR_UNION_DISCRIMINATOR_SUFFIX)
...
/*
  ...
  Simplified grammar is passed to the next level of resolution as a (FIELD) declaration.
*/
#define P00_FIELD_(P00_MODE_TYPE_NAME, FIELD)				\
  MR_IF_ELSE (MR_IS_IN_PAREN (FIELD))					\
    ...
    (MR_IF_ELSE (MR_HAS_COMMA (MR_PASTE2 (MR_IS_BUILTIN_, FIELD)))	\
     (P00_FIELD_DETECT (P00_MODE_TYPE_NAME, (FIELD), /* SUFFIX */ ))	\
...
#define MR_BI_TYPES_2_(TYPE, NAME, TYPE_, ...) MR_IF_ELSE (MR_IS_EMPTY (__VA_ARGS__)) (TYPE, NAME) (MR_BI_TYPES_3 (TYPE_, __VA_ARGS__, TYPE_ MR_PASTE2 (MR_IS_BUILTIN_, __VA_ARGS__)))
#define MR_BI_TYPES_3(...) MR_BI_TYPES_3_ (__VA_ARGS__)
#define MR_BI_TYPES_3_(TYPE, NAME, TYPE_, ...) MR_IF_ELSE (MR_IS_EMPTY (__VA_ARGS__)) (TYPE, NAME) (MR_BI_TYPES_4 (TYPE_, __VA_ARGS__, TYPE_ MR_PASTE2 (MR_IS_BUILTIN_, __VA_ARGS__)))
#define MR_BI_TYPES_4(...) MR_BI_TYPES_4_ (__VA_ARGS__)
#define MR_BI_TYPES_4_(TYPE, NAME, TYPE_, ...) MR_IF_ELSE (MR_IS_EMPTY (__VA_ARGS__)) (TYPE, NAME) (MR_BI_TYPES_5 (TYPE_, __VA_ARGS__, TYPE_ MR_PASTE2 (MR_IS_BUILTIN_, __VA_ARGS__)))
#define MR_BI_TYPES_5(...) MR_BI_TYPES_5_ (__VA_ARGS__)
#define MR_BI_TYPES_5_(TYPE, NAME, TYPE_, ...) MR_IF_ELSE (MR_IS_EMPTY (__VA_ARGS__)) (TYPE, NAME) (TYPE_, __VA_ARGS__)
...
#define MR_IS_BUILTIN_mr_int128_t mr_int128_t,
#define MR_IS_BUILTIN_mr_uint128_t mr_uint128_t,
#define MR_IS_BUILTIN___int128 __int128,
...
#define MR_IS_BUILTIN__Atomic _Atomic,
...
#define MR_AUTO_PROTO(MR_TYPE_NAME, TYPE, ...) MR_IF_ELSE (MR_IS_EMPTY (__VA_ARGS__)) (MR_EVAL_ARGS (MR_FIELD_PROTO, MR_TYPE_NAME, MR_BI_TYPES (TYPE), /* SUFFIX */ )) (MR_FIELD_PROTO (MR_TYPE_NAME, TYPE, __VA_ARGS__, /* SUFFIX */ ))
#define MR_VOID_PROTO(MR_TYPE_NAME, TYPE, ...) MR_IF_ELSE (MR_IS_EMPTY (__VA_ARGS__)) (MR_EVAL_ARGS (MR_VOID_PROTO_, MR_TYPE_NAME, MR_BI_TYPES (TYPE), /* SUFFIX */ )) (MR_VOID_PROTO_ (MR_TYPE_NAME, TYPE, __VA_ARGS__, /* SUFFIX */ ))
...
#define MR_AUTO_STUB(MR_TYPE_NAME, TYPE, ...) MR_IF_ELSE (MR_IS_EMPTY (__VA_ARGS__)) (MR_EVAL_ARGS (MR_FIELD_STUB, MR_TYPE_NAME, MR_BI_TYPES (TYPE))) (MR_FIELD_STUB (MR_TYPE_NAME, TYPE, __VA_ARGS__))
#define MR_ARRAY_STUB MR_FIELD_STUB
#define MR_BITFIELD_STUB MR_FIELD_STUB
#define MR_ARRAY_OR_BITFIELD_STUB MR_FIELD_STUB
#define MR_VOID_STUB MR_AUTO_STUB
...
#define MR_CAST_TO_PTR(OBJ)						\
  __builtin_choose_expr							\
  ((MR_POINTER_TYPE_CLASS == __builtin_classify_type (OBJ)) &&		\
