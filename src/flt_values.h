...
#define MR_ISNAN(X) ({							\
    __typeof__ (X) _x_ = (X);						\
    __builtin_choose_expr (__builtin_types_compatible_p (__typeof__ (_x_), float), \
			   ((ieee_float_t)(float)_x_).ieee_754_float_nan.exponent == IEEE_754_FLOAT_NAN_ENUM_T, \
			   __builtin_choose_expr (__builtin_types_compatible_p (__typeof__ (_x_), double), \
						  ((ieee_double_t)(double)_x_).ieee_754_double_nan.exponent == IEEE_754_DOUBLE_NAN_ENUM_T, \
						  __builtin_choose_expr (__builtin_types_compatible_p (__typeof__ (_x_), long double), \
									 ((((ieee_long_double_t)(long double)_x_).ieee_854_long_double_nan.exponent == IEEE_854_LONG_DOUBLE_NAN_ENUM_T) || \
									  (((ieee_long_double_t)(long double)_x_).ieee_854_long_double_nan.exponent == IEEE_854_LONG_DOUBLE_NAN_ZERO_ONE_ENUM_T)), \
									 false))); })
