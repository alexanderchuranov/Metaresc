...
#define LD_LDBL_MAX ((ieee_long_double_t){ { .ieee_854_long_double = { .mantissa = -1, .exponent = -2, .sign = MR_PLUS, }, }, }).long_double
#define LD_LDBL_MIN ((ieee_long_double_t){ { .ieee_854_long_double = { .mantissa = (1ULL << (IEEE_854_LONG_DOUBLE_MANTISSA - 1)), .exponent = 1, .sign = MR_PLUS, }, }, }).long_double
