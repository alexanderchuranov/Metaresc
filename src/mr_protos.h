...
TYPEDEF_UNION (mr_ptr_t, ATTRIBUTES (__attribute__((transparent_union)), "pointer on any type"),
	       ...
	       (char *, string),
	       (__typeof__ (offsetof (mr_dummy_struct_t, dummy_field)), offset),
...
TYPEDEF_STRUCT (mr_fd_t, ATTRIBUTES ( , "Metaresc field descriptor"),
		...
		(__typeof__ (offsetof (mr_dummy_struct_t, dummy_field)), offset, , "offset in structure"),
		(__typeof__ (sizeof (0)), size, , "size of field"),
...
TYPEDEF_STRUCT (mr_td_t, ATTRIBUTES ( , "Metaresc type descriptor"),
		...
		(__typeof__ (sizeof (0)), size, , "size of type"),
		(__typeof__ (sizeof (0)), size_effective, , "effective size"),
