...
#define RL_COMMENTED_ENUM_DEF(...) RL_UNFOLD (RL_COMMENTED_ENUM_DEF, __VA_ARGS__)
...
#define RL_ENUM_DEF_PROTO(NAME, RHS...) NAME RHS,
#define RL_COMMENTED_ENUM_DEF_PROTO(NAME, RHS, COM...) NAME RHS,
...
#define RL_ENUM_DEF_DESC(NAME, RHS...) RL_ENUM_DEF_DESC_ (RL_TYPE_NAME, NAME, RHS)
#define RL_ENUM_DEF_DESC_(RL_TYPE_NAME, NAME, RHS...) { .type = RL_STRINGIFY (RL_TYPE_NAME), .name = #NAME, .value = NAME, .rl_type = RL_TYPE_ENUM, .ext = NULL, .comment = "", },
#define RL_COMMENTED_ENUM_DEF_DESC(NAME, RHS, COM...) RL_COMMENTED_ENUM_DEF_DESC_ (RL_TYPE_NAME, NAME, RHS, COM)
#define RL_COMMENTED_ENUM_DEF_DESC_(RL_TYPE_NAME, NAME, RHS, COM...) { .type = RL_STRINGIFY (RL_TYPE_NAME), .name = #NAME, .value = NAME, .rl_type = RL_TYPE_ENUM, .ext = NULL, .comment = "" COM, },
