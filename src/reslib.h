...
#define RL_TYPE_ARGN_(RL_TYPE, RL_TYPE_NAME, TYPE, NAME, ...) RL_TYPE (RL_TYPE_NAME, TYPE, NAME, __VA_ARGS__)
...
#define RL_ANON_UNION_DEF_PROTO(RL_TYPE_NAME, ATTR...) RL_ANON_UNION_PROTO_ (RL_TYPE_NAME, , ATTR)
...
#define RL_FUNC_DESC(RL_TYPE_NAME, TYPE, NAME, ARGS, COM...) RL_FIELD_DESC (RL_TYPE_NAME, TYPE, NAME, , RL_TYPE_FUNC, RL_TYPE_EXT_NONE, COM, .param = { .func_param = { .alloc_size = -1, .size = 0, .data = (rl_fd_t []){ RL_FUNC_ARG (TYPE, "return value") RL_FOREACH (RL_FUNC_ARG, RL_REMOVE_PAREN (ARGS)) { .rl_type = RL_TYPE_TRAILING_RECORD, }, }, }, })
...
#define RL_ANON_UNION_DEF_DESC(RL_TYPE_NAME, ATTR...) RL_ANON_UNION_DESC_ (RL_TYPE_NAME, , ATTR)
