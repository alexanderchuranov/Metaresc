...
*/
#define P00_TYPEDEF_MODE(P00_MODE, P00_TYPE, ...) MR_PASTE2 (P00_TYPEDEF_, P00_TYPE) (P00_MODE, P00_TYPE, __VA_ARGS__)
...
#define P00_TYPEDEF_CHAR_ARRAY(P00_MODE, P00_TYPE, ...) MR_PASTE2 (MR_TYPEDEF_CHAR_ARRAY_, P00_MODE) (__VA_ARGS__)
#define P00_TYPEDEF_FUNC(P00_MODE, P00_TYPE, ...) MR_PASTE2 (MR_TYPEDEF_FUNC_, P00_MODE) (__VA_ARGS__)
...
#define P00_TYPEDEF_COMPAUND_(P00_MODE, P00_TYPE, P00_TYPE_NAME, FIRST, ...) \
  MR_IF_ELSE (MR_HAS_NO_PAREN (FIRST))					\
  (MR_IF_ELSE (MR_PASTE2 (P00_IS_ATTRIBUTES_EQ_, FIRST))		\
...
#define MR_TYPEDEF_CHAR_ARRAY_PROTO(MR_TYPE_NAME, SIZE, ...) typedef char MR_TYPE_NAME[SIZE];
#define MR_TYPEDEF_FUNC_PROTO(MR_TYPE_NAME, RET_TYPE, ARGS, ...) typedef RET_TYPE (*MR_TYPE_NAME) ARGS;
...
#define MR_TYPEDEF_CHAR_ARRAY_DESC(MR_TYPE_NAME, SIZE, /* COMMENTS */ ...) MR_TYPEDEF_DESC (MR_TYPE_NAME, MR_TYPE_CHAR_ARRAY) MR_TYPEDEF_END_DESC (MR_TYPE_NAME, __VA_ARGS__)
#define MR_TYPEDEF_FUNC_DESC(MR_TYPE_NAME, RET_TYPE, ARGS, /* COMMENTS */ ...) \
  MR_TYPEDEF_DESC (MR_TYPE_NAME, MR_TYPE_FUNC_TYPE)			\
  MR_FUNC_ARG (RET_TYPE, "return value")				\
