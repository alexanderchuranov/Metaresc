...
#define RL_TYPE_ARGN(RL_TYPE, RL_TYPE_NAME, TYPE, NAME, ...) RL_TYPE (RL_TYPE_NAME, TYPE, NAME, __VA_ARGS__)
...
#define RL_AUTO_PROTO(...) RL_TYPE_ARGN (RL_FIELD_PROTO, __VA_ARGS__)
#define RL_NONE_PROTO(...) RL_TYPE_ARGN (RL_FIELD_PROTO, __VA_ARGS__)
#define RL_CHAR_ARRAY_PROTO(...) RL_TYPE_ARGN (RL_FIELD_PROTO, __VA_ARGS__)
...
#define RL_AUTO_DESC(...) RL_TYPE_ARGN (RL_AUTO_DESC_, __VA_ARGS__)
#define RL_NONE_DESC(...) RL_TYPE_ARGN (RL_NONE_DESC_, __VA_ARGS__)
#define RL_CHAR_ARRAY_DESC(...) RL_TYPE_ARGN (RL_CHAR_ARRAY_DESC_, __VA_ARGS__)
