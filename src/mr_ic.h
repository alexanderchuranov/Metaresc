...
extern mr_ptr_t * mr_ic_tree_add (mr_ic_t * ic, mr_ptr_t key);
extern mr_status_t mr_ic_tree_del (mr_ic_t * ic, mr_ptr_t key);
extern mr_ptr_t * mr_ic_tree_find (mr_ic_t * ic, mr_ptr_t key);
extern mr_status_t mr_ic_tree_foreach (mr_ic_t * ic, mr_visit_fn_t visit_fn, const void * context);
extern mr_status_t mr_ic_tree_index (mr_ic_t * ic, mr_ic_rarray_t * rarray);
extern void mr_ic_tree_free (mr_ic_t * ic);
extern mr_status_t mr_ic_tree_new (mr_ic_t * ic, mr_compar_fn_t compar_fn, char * key_type, mr_res_t * context);
...
mr_ic_new (mr_ic_t * ic, mr_hash_fn_t hash_fn, mr_compar_fn_t compar_fn, char * key_type, mr_ic_type_t mr_ic_type, mr_res_t * context)
{
  ...
  switch (mr_ic_type)
    ...
    case MR_IC_TREE:
      return (mr_ic_tree_new (ic, compar_fn, key_type, context));
