...
RL_START_TEST (anon_union, "anonymous union") {
...
RL_START_TEST (named_anon_union, "named anonymous union") {
...
RL_START_TEST (union_enum_float, "union discriminated by enum") {
...
RL_START_TEST (union_enum_int32, "union discriminated by enum") {
...
RL_START_TEST (union_enum_ptr, "union discriminated by pointer on enum") {
...
RL_START_TEST (union_int_0, "union discriminated by int") {
...
RL_START_TEST (union_int_1, "union discriminated by int") {
...
RL_START_TEST (union_str_ptr, "union discriminated by pointer on string") {
