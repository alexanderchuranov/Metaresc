...
START_TEST (huge_val_double) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_DOUBLE, HUGE_VAL - HUGE_VAL * I); } END_TEST
START_TEST (dbl_max_double) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_DOUBLE, DBL_MAX - DBL_MAX * I); } END_TEST
START_TEST (dbl_min_double) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_DOUBLE, DBL_MIN - DBL_MIN * I); } END_TEST
START_TEST (dbl_epsilon_double) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_DOUBLE, DBL_EPSILON - DBL_EPSILON * I); } END_TEST
START_TEST (pi_double) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_DOUBLE, MR_PI + MR_E * I); } END_TEST
