...
RL_START_TEST (int8_ptr, "pointer on int") {
...
RL_START_TEST (uint8_ptr, "pointer on uint") {
...
RL_START_TEST (int16_ptr, "pointer on int") {
...
RL_START_TEST (uint16_ptr, "pointer on uint") {
...
RL_START_TEST (int32_ptr, "pointer on int") {
...
RL_START_TEST (uint32_ptr, "pointer on uint") {
...
RL_START_TEST (int64_ptr, "pointer on int") {
...
RL_START_TEST (uint64_ptr, "pointer on uint") {
