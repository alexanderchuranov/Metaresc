...
START_TEST (huge_val_long_double) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_LONG_DOUBLE, HUGE_VAL - HUGE_VAL * I); } END_TEST
START_TEST (ldbl_max_long_double) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_LONG_DOUBLE, LD_LDBL_MAX - LD_LDBL_MAX * I); } END_TEST
START_TEST (ldbl_min_long_double) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_LONG_DOUBLE, LD_LDBL_MIN - LD_LDBL_MIN * I); } END_TEST
START_TEST (ldbl_epsilon_long_double) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_LONG_DOUBLE, LDBL_EPSILON - LDBL_EPSILON * I); } END_TEST
START_TEST (pi_long_double) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_LONG_DOUBLE, MR_PI + MR_E * I); } END_TEST
