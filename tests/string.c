...
RL_START_TEST (null_string_t, "NULL string") { ALL_METHODS (ASSERT_SAVE_LOAD_CHAR_POINTER, NULL); } END_TEST
...
RL_START_TEST (pointer_match_content, "strings points on another field") {
...
RL_START_TEST (pointer_match_another_content, "strings points on the some other content") {
