...
RL_START_TEST (union_rl_ptr_int, "rl_ptr_t is a pointer on any ResLib type") {
...
RL_START_TEST (union_rl_ptr_enum, "rl_ptr_t is a pointer on any ResLib type") {
...
RL_START_TEST (union_rl_ptr_enum_ptr, "rl_ptr_t is a pointer on any ResLib type") {
