...
MR_START_TEST (union_mr_ptr_int, "mr_ptr_t is a pointer on any ResLib type") {
...
MR_START_TEST (union_mr_ptr_enum, "mr_ptr_t is a pointer on any ResLib type") {
...
MR_START_TEST (union_mr_ptr_enum_ptr, "mr_ptr_t is a pointer on any ResLib type") {
  ALL_METHODS (ASSERT_SAVE_LOAD_MR_PTR, struct_union_enum_ptr_t, (enum_discriminator_t[]){ UD_INT32 });
} END_TEST

MR_START_TEST (union_mr_ptr_string_y, "mr_ptr_t is a pointer on any ResLib type") {
...
MR_START_TEST (union_mr_ptr_string, "mr_ptr_t is a pointer on any ResLib type") {
