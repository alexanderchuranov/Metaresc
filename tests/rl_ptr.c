...
RL_START_TEST (union_rl_ptr_int_0, "rl_ptr_t is a pointer on any ResLib type") {
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_int8_t, 0);
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_int16_t, 0);
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_int32_t, 0);
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_int64_t, 0);
} END_TEST
...
RL_START_TEST (union_rl_ptr_enum_float, "rl_ptr_t is a pointer on any ResLib type") {
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_enum8_t, U8D_FLOAT);
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_enum16_t, U16D_FLOAT);
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_enum32_t, U32D_FLOAT);
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_enum64_t, U64D_FLOAT);
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_enum_t, UD_FLOAT);
} END_TEST
...
RL_START_TEST (union_rl_ptr_int_ptr_0, "rl_ptr_t is a pointer on any ResLib type") {
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_int8_ptr_t, (int8_t[]){ 0 });
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_int16_ptr_t, (int16_t[]){ 0 });
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_int32_ptr_t, (int32_t[]){ 0 });
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_int64_ptr_t, (int64_t[]){ 0 });
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_enum_ptr_t, (enum_discriminator_t[]){ UD_FLOAT });
} END_TEST
...
RL_START_TEST (union_rl_ptr_string_x, "rl_ptr_t is a pointer on any ResLib type") {
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_string_t, "x");
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_ca_t, "x");
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_string_ptr_t, (string_t[]){ "x" });
  ALL_METHODS (ASSERT_SAVE_LOAD_RL_PTR, struct_union_ca_ptr_t, (ca2_t[]){ "x" });
} END_TEST
