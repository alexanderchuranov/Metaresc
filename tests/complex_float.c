...
START_TEST (huge_valf_float) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_FLOAT, HUGE_VALF - HUGE_VALF * I); } END_TEST
...
START_TEST (pi_float_complex) { ALL_METHODS (ASSERT_SAVE_LOAD_COMPLEX_FLOAT, MR_PI + MR_E * I); } END_TEST 
